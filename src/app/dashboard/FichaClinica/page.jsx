...
//FUNCION PARA LISTAR TODOS LOS PACIENTES INGRESADOS
    ...
    <div>
        <div>
            <div className="flex">
                <h1 className="text-2xl font-bold text-blue-600">Ficha Clinica del Paciente  </h1> <span> <ClipboardDocumentListIcon className="h-8 w-8 text-blue-600" /></span>
                        ...
                        <TableBody>
                            {pacientesParaRenderizarEnTabla.map((paciente) => (
                                <TableRow key={paciente.id_paciente} className="hover:bg-sky-50">
                                    ...
                                    >
                                        <BookOpenIcon className="h-6 w-6 text-sky-700 hover:text-green-500" />
                                    </button></TableCell>
